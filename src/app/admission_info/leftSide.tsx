export const LeftSide = ()=>{
    return(
        <aside className="p-[16px] bg-[#F9D68A] lg:rounded-[4px] w-full lg:w-1/3 flex-col flex gap-[24px]">
            <div className="bg-[#FFFBF9] p-[16px] flex gap-[10px] rounded-[4px]">
                ...
                <button className="bg-[#FF5900] py-[8px] px-[16px] w-[101px] flex items-center justify-center gap-[2px] text-white rounded-[8px]">
                    Search
                    <span>
            ...
            <div className="hidden text-[#0F0F0F] bg-[#FFFFFF] p-[16px] rounded-[4px] lg:flex flex-col gap-[12px]">
