...
export const Hero = () =>{
    return(
        <section className="px-[16px] py-[24px] md:px-[100px]">
            <article className="bg-[#FFEEE6] rounded-[41px] px-[41px] py-[35.5] ">
            <aside className="flex flex-col md:justify-center md:items-center lg:flex-row gap-[40px] lg:gap-[51px]">
                ...
                <h2 className="text-[32px] md:text-[48px] leading-[50px] lg:max-w-[603px] font-semibold">Your Learning Companion For Academic
                   Success!
                </h2>
                <p className="text-[18px] max-w-[547px] flex-col flex gap-[12px]">
                ...
                <aside className="lg:w-[40%] md:w-[80%] w-[100%]  lg:max-w-[498px] relative">
            ...
            <div className="flex lg:justify-between justify-center lg:flex-row flex-col items-center mt-5 lg:gap-[38px] gap-[16px]">
