  ...
  return (
    <section className="flex items-start md:items-center justify-center h-screen ">
      ...
      {/* Left Side - Background Image */}
        <AuthPage />
        {/* Right Side - Form */}
        <div className="w-[50px] h-[50px] rounded-full flex items-center justify-center absolute md:right-0 top-6 md:top-12 right-[0%] lg:right-[10%] bg-white" onClick={()=>{setShowLogin(false)}}><X/></div>
